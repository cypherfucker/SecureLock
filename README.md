...
- **Browser Compatibility**: Requires a modern browser support (Chrome 37+, Firefox 34+, ~~Safari 7+~~, Edge 12+) **[We strongly advise against using Safari or any WebKit browser](https://github.com/cypherfucker/SecureLock/blob/main/public/safari_libsodium_crypto.md)**
